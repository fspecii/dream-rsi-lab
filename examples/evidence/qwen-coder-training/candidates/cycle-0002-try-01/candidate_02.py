# cycle-0002-try-01-edit-02-width
# Adjust width based on history count and worker count.
DEFAULT_BETA = 0.6
...
def plan_width(beta, hard_depth, hard_width, history_count, last_gain, last_work, plateau_rounds, workers):
    return hard_width if history_count < 2 else max(workers, int(hard_width * beta))
