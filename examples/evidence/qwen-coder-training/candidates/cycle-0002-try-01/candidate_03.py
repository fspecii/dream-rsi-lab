# cycle-0002-try-01-edit-03-eligible
# Avoid repeated non-improving refinements, but keep roots and justified repairs eligible.
DEFAULT_BETA = 0.6
...
def eligible(anchor, baseline, beta, depth, failures, gain, global_best, is_root, last_failed, latest, legal_count, opened, probes, remaining, rounds, stagnation, successes, workers):
    return not last_failed and stagnation < (1 + 2 * beta)
